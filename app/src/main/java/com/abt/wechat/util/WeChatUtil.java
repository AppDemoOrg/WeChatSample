package com.abt.wechat.util;

import android.widget.Toast;

import com.abt.wechat.WeChatApp;
...
public class WeChatUtil {
    ...
    public static void reqToWx() {
        api = WXAPIFactory.createWXAPI(WeChatApp.getAppContext(), APP_ID, true);
    ...
    public static void loginToWx() {
        if (!api.isWXAppInstalled()) {
            Toast.makeText(WeChatApp.getAppContext(),
